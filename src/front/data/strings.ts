...
export const mainPageData = {
  ...
  regForm: 'Кто ты?',
  ifHasUUID: 'Если ты уже участник этой комнаты - введи сюда свой код либо ',
  regFormText:
    'Остался последний шаг. Введи свое имя и мы добавим тебя в комнату ',
  ...
  userNotFound: 'Ты уже состоишь в другой комнате либо ввел неверный код',
  ...
  relockSuccess: 'Пары переназнчены! Не забудь сказать об этом друзьям.',
  ...
  pairsNotSet: 'Пары еще не назначены. Это может сделать админ комнаты',
};
